...
struct set_alias aliases[] = {
    ...
    {"NAME_MAX",NAME_MAX},{"PATH_MAX",PATH_MAX},{"DIR_BASE_INC_RATE",DIR_BASE_INC_RATE},
    {"DIR_INC_RATE",DIR_INC_RATE},{"T_DIR",T_DIR},{"T_REG",T_REG},{"T_DEV",T_DEV},{"T_BDEV",T_BDEV},
    {"T_SOCK",T_SOCK},{"T_FIFO",T_FIFO},{"T_OTHER",T_OTHER},{"T_SYMLINK",T_SYMLINK},{"T_FILE_MISSING",T_FILE_MISSING},
    #ifdef __SORT_ELEMENTS_ENABLE__
    {"SORT_NONE",SORT_NONE},{"SORT_TYPE",SORT_TYPE},{"SORT_SIZE",SORT_SIZE},{"SORT_NAME",SORT_NAME},
    {"SORT_LNAME",SORT_LNAME},{"SORT_ZNAME",SORT_ZNAME},{"SORT_LZNAME",SORT_LZNAME},
