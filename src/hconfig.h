...
#define LINE_SIZE_MAX (1<<14)
#define DIR_INC_RATE 128
#define DIR_BASE_INC_RATE 64
#define SEARCH_LIST_INC_RATE 64
#define CONSOLE_HIStORY_INC_RATE 16
#define CONSOLE_HISTORY_MAX_SIZE 64
#define HISTORY_INC_RATE 512
#define HISTORY_MAX_RATE (1<<14)